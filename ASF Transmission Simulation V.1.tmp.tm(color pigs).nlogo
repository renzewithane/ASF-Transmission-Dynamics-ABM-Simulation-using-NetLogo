...
to create-agents
  create-turtles num-agents [
    set color pink ; Set the initial color to pink during setup
    set shape "pigg" ; Check out other shapes under Tools > Turtle shape editor
    set size 2
...
to move-agents
  ask turtles [
    ...
    ; Change color randomly among red, pink, blue, and green
