...
to update-model
  set weeks weeks + 1
  let death-rate 0.05 ; Adjust this based on your scenario
  let deaths-this-week count turtles with [random-float 1 < death-rate]

  ; Update deaths and remaining-pigs
  set deaths deaths + deaths-this-week
  set remaining num-agents - deaths

  ; Display information
  print (word "Week: " weeks ", Deaths: " deaths ", Remaining : " remaining)
end
@#$#@#$#@
GRAPHICS-WINDOW
398
